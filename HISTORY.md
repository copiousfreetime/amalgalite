...
* Update to SQLite 3.51.0
  - enabling new compile time options
    ...
    * [`SQLITE_ENABLE_PERCENTILE`](https://sqlite.org/compile.html#enable_percentile)
    * [`SQLITE_ENABLE_HIDDEN_COLUMNS`](https://sqlite.org/compile.html#enable_hidden_columns)
  - update with new autogenerated constants for CArray
  - update with new autogenerated constants additional flags and result codes
  - update specs that were affected by changes in sqlite3 internal limit updates
