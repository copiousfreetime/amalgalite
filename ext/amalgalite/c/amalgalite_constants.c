...
void Init_amalgalite_constants( )
{
    ...
    /**
     * module encapsulating the SQLite3 C extension constants for CArray
     */
    VALUE mC_CArray = rb_define_module_under(mC, "CArray");
    ...
    /**
     * module encapsulating the SQLite3 C extension constants for SetLock
     */
    VALUE mC_SetLock = rb_define_module_under(mC, "SetLock");
    ...
    /*  4 -- Data is struct iovec */
    rb_define_const(mC_CArray, "BLOB", INT2FIX(SQLITE_CARRAY_BLOB));

    /*  2 -- Data is doubles */
    rb_define_const(mC_CArray, "DOUBLE", INT2FIX(SQLITE_CARRAY_DOUBLE));

    /*  0 -- Data is 32-bit signed integers */
    rb_define_const(mC_CArray, "INT32", INT2FIX(SQLITE_CARRAY_INT32));

    /*  1 -- Data is 64-bit signed integers */
    rb_define_const(mC_CArray, "INT64", INT2FIX(SQLITE_CARRAY_INT64));

    /*  3 -- Data is char* */
    rb_define_const(mC_CArray, "TEXT", INT2FIX(SQLITE_CARRAY_TEXT));
    ...
    /* no meaningful autogenerated documentation -- constant is self explanatory ?*/
    rb_define_const(mC_ChangesetApply, "FKNOACTION", INT2FIX(SQLITE_CHANGESETAPPLY_FKNOACTION));
    ...
    /*  -1 -- Do no work at all */
    rb_define_const(mC_Checkpoint, "NOOP", INT2FIX(SQLITE_CHECKPOINT_NOOP));
    ...
    /*  30 -- int* */
    rb_define_const(mC_Config, "ROWID_IN_VIEW", INT2FIX(SQLITE_CONFIG_ROWID_IN_VIEW));
    ...
    /*  1020 -- int int* */
    rb_define_const(mC_DBConfig, "ENABLE_ATTACH_CREATE", INT2FIX(SQLITE_DBCONFIG_ENABLE_ATTACH_CREATE));

    /*  1021 -- int int* */
    rb_define_const(mC_DBConfig, "ENABLE_ATTACH_WRITE", INT2FIX(SQLITE_DBCONFIG_ENABLE_ATTACH_WRITE));

    /*  1022 -- int int* */
    rb_define_const(mC_DBConfig, "ENABLE_COMMENTS", INT2FIX(SQLITE_DBCONFIG_ENABLE_COMMENTS));
    ...
    /* no meaningful autogenerated documentation -- constant is self explanatory ?*/
    rb_define_const(mC_DBStatus, "TEMPBUF_SPILL", INT2FIX(SQLITE_DBSTATUS_TEMPBUF_SPILL));
    ...
    /* no meaningful autogenerated documentation -- constant is self explanatory ?*/
    rb_define_const(mC_Fcntl, "BLOCK_ON_CONNECT", INT2FIX(SQLITE_FCNTL_BLOCK_ON_CONNECT));
    ...
    /* no meaningful autogenerated documentation -- constant is self explanatory ?*/
    rb_define_const(mC_Fcntl, "FILESTAT", INT2FIX(SQLITE_FCNTL_FILESTAT));
    ...
    /* no meaningful autogenerated documentation -- constant is self explanatory ?*/
    rb_define_const(mC_Fcntl, "NULL_IO", INT2FIX(SQLITE_FCNTL_NULL_IO));
    ...
    /* no meaningful autogenerated documentation -- constant is self explanatory ?*/
    rb_define_const(mC_IOCap, "SUBPAGE_READ", INT2FIX(SQLITE_IOCAP_SUBPAGE_READ));
    ...
    /*  0x00000002 -- Display idxNum as hex */
    rb_define_const(mC_Index, "SCAN_HEX", INT2FIX(SQLITE_INDEX_SCAN_HEX));

    /*  0x00000001 -- Scan visits at most 1 row */
    ...
    /* no meaningful autogenerated documentation -- constant is self explanatory ?*/
    rb_define_const(mC_Prepare, "DONT_LOG", INT2FIX(SQLITE_PREPARE_DONT_LOG));
    ...
    /* no meaningful autogenerated documentation -- constant is self explanatory ?*/
    rb_define_const(mC_ResultCode, "CONSTRAINT_DATATYPE", INT2FIX(SQLITE_CONSTRAINT_DATATYPE));
    ...
    /* no meaningful autogenerated documentation -- constant is self explanatory ?*/
    rb_define_const(mC_ResultCode, "ERROR_KEY", INT2FIX(SQLITE_ERROR_KEY));

    /* no meaningful autogenerated documentation -- constant is self explanatory ?*/
    rb_define_const(mC_ResultCode, "ERROR_MISSING_COLLSEQ", INT2FIX(SQLITE_ERROR_MISSING_COLLSEQ));

    /* no meaningful autogenerated documentation -- constant is self explanatory ?*/
    rb_define_const(mC_ResultCode, "ERROR_RESERVESIZE", INT2FIX(SQLITE_ERROR_RESERVESIZE));
    ...
    /* no meaningful autogenerated documentation -- constant is self explanatory ?*/
    rb_define_const(mC_ResultCode, "ERROR_UNABLE", INT2FIX(SQLITE_ERROR_UNABLE));
    ...
    /* no meaningful autogenerated documentation -- constant is self explanatory ?*/
    rb_define_const(mC_ResultCode, "IOERR_BADKEY", INT2FIX(SQLITE_IOERR_BADKEY));
    ...
    /* no meaningful autogenerated documentation -- constant is self explanatory ?*/
    rb_define_const(mC_ResultCode, "IOERR_CODEC", INT2FIX(SQLITE_IOERR_CODEC));
    ...
    /* no meaningful autogenerated documentation -- constant is self explanatory ?*/
    rb_define_const(mC_ResultCode, "IOERR_IN_PAGE", INT2FIX(SQLITE_IOERR_IN_PAGE));
    ...
    /* no meaningful autogenerated documentation -- constant is self explanatory ?*/
    rb_define_const(mC_ResultCode, "NOTICE_RBU", INT2FIX(SQLITE_NOTICE_RBU));
    ...
    /* no meaningful autogenerated documentation -- constant is self explanatory ?*/
    rb_define_const(mC_Session, "OBJCONFIG_ROWID", INT2FIX(SQLITE_SESSION_OBJCONFIG_ROWID));

    /* no meaningful autogenerated documentation -- constant is self explanatory ?*/
    rb_define_const(mC_Session, "OBJCONFIG_SIZE", INT2FIX(SQLITE_SESSION_OBJCONFIG_SIZE));

    /* no meaningful autogenerated documentation -- constant is self explanatory ?*/
    rb_define_const(mC_SetLock, "BLOCK_ON_CONNECT", INT2FIX(SQLITE_SETLK_BLOCK_ON_CONNECT));
    ...
    /* no meaningful autogenerated documentation -- constant is self explanatory ?*/
    rb_define_const(mC_TextEncoding, "RESULT_SUBTYPE", INT2FIX(SQLITE_RESULT_SUBTYPE));

    /* no meaningful autogenerated documentation -- constant is self explanatory ?*/
    rb_define_const(mC_TextEncoding, "SELFORDER1", INT2FIX(SQLITE_SELFORDER1));
