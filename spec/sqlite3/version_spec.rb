...
describe "Amalgalite::SQLite3::Version" do
  it "should have the sqlite3 version" do
    ...
    Amalgalite::SQLite3::Version.to_i.should eql(3044002)
    Amalgalite::SQLite3::Version.runtime_version_number.should eql(3044002)
    ...
    Amalgalite::SQLite3::Version.compiled_version.should be == "3.44.2"
    Amalgalite::SQLite3::Version.compiled_version_number.should be == 3044002
