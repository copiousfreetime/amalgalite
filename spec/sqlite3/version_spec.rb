...
describe "Amalgalite::SQLite3::Version" do
  it "should have the sqlite3 version" do
    ...
    Amalgalite::SQLite3::Version.to_i.should eql(3007000)
    Amalgalite::SQLite3::Version.runtime_version_number.should eql(3007000)
    ...
    Amalgalite::SQLite3::Version.compiled_version.should == "3.7.0"
    Amalgalite::SQLite3::Version.compiled_version_number.should == 3007000
