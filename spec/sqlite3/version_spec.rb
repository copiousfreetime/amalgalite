...
describe "Amalgalite::SQLite3::Version" do
  it "should have the sqlite3 version" do
    ...
    Amalgalite::SQLite3::Version.to_i.should eql(3012002)
    Amalgalite::SQLite3::Version.runtime_version_number.should eql(3012002)

    Amalgalite::SQLite3::Version::MAJOR.should eql(3)
    Amalgalite::SQLite3::Version::MINOR.should eql(12)
    Amalgalite::SQLite3::Version::RELEASE.should eql(2)
    expect(Amalgalite::SQLite3::Version.to_a.size).to eql(3)

    Amalgalite::SQLite3::Version.compiled_version.should be == "3.12.2"
    Amalgalite::SQLite3::Version.compiled_version_number.should be == 3012002
