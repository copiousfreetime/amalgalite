...
== Version 1.1.1 - 2011-03-11

=== Bug Fixes

* Provide bootstrapping from an in-memory SQL buffer
* Fix adding LOADED_FEATURES (broken by a bad refactoring)

== Version 1.1.0 - 2011-03-09

=== Enhancements

* Added Amalgalite::Database#import, using sqlite3_exec under the hood,
  to support loading batches of SQL. This works around execute_batch
  failing when statement preparation breaks on long lines.
* Add support for :memory: databases to Amalgalite::Requires.
